...
sigma_squared_rng_params <- list(
  n = 1,
  shape = sigma_squared_prior[1],
  rate = sigma_squared_prior[2]
)
sigma_squared_density <- dinvgamma
sigma_squared_density_params <- list(
  shape = sigma_squared_prior[1],
  rate = sigma_squared_prior[2]
)
sigma_squared_dist_list <- list(
  rng = sigma_squared_rng,
...
MC_params <- list(
  method = method,
  nominal = list(alpha_dist_list, beta_dist_list, sigma_squared_dist_list)
)
