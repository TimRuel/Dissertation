...
IL_preallocations_file_paths <- list.files(
  path = "Preallocations/Integrated Likelihood",
  pattern = "*.Rda",
  full.names = TRUE,
  recursive = FALSE
) |>
...
mod_IL_preallocations_file_paths <- list.files(
  path = "Preallocations/Modified Integrated Likelihood",
  pattern = "*.Rda",
  full.names = TRUE,
  recursive = FALSE
) |>
