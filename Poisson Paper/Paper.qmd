...
$${#eq-4-1-13}
To find it, we start by differentiating both sides of @eq-4-1-12:
$$
...
$${#eq-4-1-13}
Evaluating at $\pi = \hat{\pi}_{\mu}$ and plugging the result into @eq-4-1-12, we have
$$
\begin{aligned}
