...
Let $X_1, ..., X_n$ be independent observations taken from some random variable $X$ with distribution $P_{\theta}$ and parameter $\theta \in \Theta$. Suppose $\Theta \subseteq \mathbb{R}^d$
