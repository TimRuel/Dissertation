...
Finally, we will assume that all probability distributions in $\mathcal{P}$ obey certain regularity conditions. A parametric model $(\mathcal{S}, \mathcal{P})$ is called *regular* if it satisfies the following conditions:

1) All of the distributions in $\mathcal{P}$ have common support;
