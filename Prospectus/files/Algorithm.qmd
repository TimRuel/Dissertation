...
@severini2018 proved that reparameterizing the nuisance parameter in terms of the ZSEP yields the same desirable properties in the subsequent integrated likelihood when $\psi$ and $\lambda$ are implicit. Suppose $\psi$ = $\varphi(\theta)$, for some function $\varphi: \Theta \to \Psi$. 
